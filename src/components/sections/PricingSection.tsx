      ...
      <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
        {tiers.map((tier, i) => (
          <ScrollReveal key={i} delay={i * 0.1}>
            <div
              className={`group relative flex flex-col h-full p-8 md:p-10 transition-all duration-500 border-glow ${
                tier.featured
            ...
            >
              {tier.featured && (
                <span className="absolute -top-3 left-8 bg-gold text-black text-[11px] font-heading font-semibold px-4 py-1 uppercase tracking-[0.15em]">
                  Most Popular
                </span>
              )}
