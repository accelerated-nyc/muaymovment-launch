...
const FooterSection = ({ onContactClick }: FooterSectionProps) => {
        ...
        <ScrollReveal delay={0.2}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-20">
            <button
              ...
              className="px-10 py-4 bg-gold text-black font-heading font-semibold text-sm uppercase tracking-[0.15em] btn-shimmer transition-all duration-500 hover:shadow-[0_0_40px_hsl(var(--gold)/0.25)]"
            >
              Schedule a Demo
            </button>
            <button
              onClick={onContactClick}
              className="px-10 py-4 border border-white/10 text-off-white font-heading font-medium text-sm uppercase tracking-[0.15em] transition-all duration-400 hover:border-gold/40 hover:text-gold"
            >
              Contact Us
            </button>
          </div>
